# Eigenvalue Computation - Implementation Reference

> **Note**: This file contains low-level implementation details using numpy/scipy. For usage examples of the `/eigenvalue-computation` skill, see [examples.md](./examples.md).
