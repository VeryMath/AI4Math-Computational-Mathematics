# GMRES - Implementation Reference

> **Note**: This file contains low-level implementation details using numpy/scipy. For usage examples of the `/generalized-minimal-residual` skill, see [examples.md](./examples.md).
