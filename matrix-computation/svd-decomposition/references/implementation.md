# SVD Decomposition - Implementation Reference

> **Note**: This file contains low-level implementation details using numpy/scipy. For usage examples of the `/svd-decomposition` skill, see [examples.md](./examples.md).
